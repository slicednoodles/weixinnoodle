...
{
	/** Logger */
	private static final Logger SBSLOGGER = LoggerFactory.getLogger( CoreUtil.class );
	...
	public static <T> T valueOf( final Class<T> clazz, final String value )
	{
		if ( clazz.isInstance( Collections.EMPTY_LIST ) || clazz.isInstance( Collections.EMPTY_MAP )
			...
			return CoreUtil.<T>valueOfJSON( jt, value );
		}
	...
	{
		return CoreUtil.<T>valueOfJSON( typeRef, value );
	}
